...
anomalies = [
    ("Reddit r/hardwareswap individual seller", "$24,000", "40% below median retail pricing - individual liquidation sale"),
...
print(f"\nDATA QUALITY CHECK:")
print("=" * 50)
print("✓ 5 different source types searched (Retail_Major, Retail_Specialist, Resale_Individual, Resale_Business, International)")
