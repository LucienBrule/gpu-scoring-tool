...
rtx_a4000_data = [
    # Retail Major
    {
        ...
        "Bulk_Notes": "Back-ordered, expected availability May 02, 2025",
    },
    {
        "Model": "RTX A4000",
        "Condition": "new",
    ...
    },
    {
        ...
        "Source_Type": "Retail_Major",
        "Bulk_Notes": "Not Available - Out of Stock",
    },
    # Retail Specialist
    {
        "Model": "RTX A4000",
        ...
        "Bulk_Notes": "Enterprise pricing available",
    },
    {
        "Model": "RTX A4000",
    ...
    },
    {
        ...
        "Quantity": 1,
        "Min_Order_Qty": 1,
        "Seller": "eBay Individual",
        "Geographic_Region": "Canada",
        "Listing_Age": "Recent",
        "Source_URL": "https://www.ebay.ca/sch/i.html?_nkw=rtx+a4000",
        "Source_Type": "Resale_Individual",
        "Bulk_Notes": "C$750.00 or Best Offer",
    },
    {
        "Model": "RTX A4000",
        "Condition": "used",
    ...
    # Resale Business (eBay stores)
    {
        ...
        "Quantity": 9,
        "Min_Order_Qty": 1,
        "Seller": "ReSpec.io Store (eBay)",
        "Geographic_Region": "US domestic",
        "Listing_Age": "Current",
        "Source_URL": "https://www.ebay.ca/itm/156035032609",
        "Source_Type": "Resale_Business",
        "Bulk_Notes": "Professionally renewed, 1yr warranty, 418 sold",
    },
    {
        "Model": "RTX A4000",
        "Condition": "refurbished",
        ...
        "Quantity": 1,
        "Min_Order_Qty": 1,
        "Seller": "HP Refurbished (eBay)",
        "Geographic_Region": "US domestic",
        "Listing_Age": "Current",
        "Source_URL": "https://www.ebay.ca/sch/i.html?_nkw=rtx+a4000",
        "Source_Type": "Resale_Business",
        "Bulk_Notes": "C$999.37, 6 sold",
    },
    {
        "Model": "RTX A4000",
        "Condition": "refurbished",
        ...
        "Quantity": 1,
        "Min_Order_Qty": 1,
        "Seller": "Newegg Refurbished",
        "Geographic_Region": "US domestic",
        "Listing_Age": "Current",
        "Source_URL": "https://www.newegg.com/p/1FT-000P-005P8",
        "Source_Type": "Resale_Business",
        "Bulk_Notes": "Tech Trends seller, $828.99",
    },
    {
        "Model": "RTX A4000",
        "Condition": "refurbished",
        ...
        "Quantity": 1,
        "Min_Order_Qty": 1,
        "Seller": "eBay Business Seller",
        "Geographic_Region": "US domestic",
        "Listing_Age": "Current",
        "Source_URL": "https://www.ebay.ca/sch/i.html?_nkw=rtx+a4000",
        "Source_Type": "Resale_Business",
        "Bulk_Notes": "C$1,019.78, 7 sold",
    },
    {
        "Model": "RTX A4000",
        "Condition": "new",
        ...
        "Source_URL": "https://www.ebay.ca/sch/i.html?_nkw=rtx+a4000",
        "Source_Type": "Resale_Business",
        "Bulk_Notes": "C$1,269.00, 15% off original price",
    },
    {
        "Model": "RTX A4000",
        "Condition": "new",
        ...
        "Quantity": 1,
        "Min_Order_Qty": 1,
        "Seller": "eBay Sealed Box",
        "Geographic_Region": "US domestic",
        "Listing_Age": "Current",
        "Source_URL": "https://www.ebay.ca/sch/i.html?_nkw=rtx+a4000",
        "Source_Type": "Resale_Business",
        "Bulk_Notes": "C$1,358.34 or Best Offer, sealed box",
    },
    ...
    },
    {
        ...
        "Quantity": "unknown",
        "Min_Order_Qty": 1,
        "Seller": "China eBay Seller",
        "Geographic_Region": "Asia/HK",
        "Listing_Age": "Current",
        "Source_URL": "https://www.ebay.ca/sch/i.html?_nkw=rtx+a4000",
        "Source_Type": "International",
        "Bulk_Notes": "C$1,849.19, from China",
    },
    {
        "Model": "RTX A4000",
        "Condition": "new",
    ...
    },
    {
        ...
        "Quantity": "1+",
        "Min_Order_Qty": 1,
        "Seller": "Alibaba Seller 4",
        "Geographic_Region": "Asia/HK",
        "Listing_Age": "Current",
        "Source_URL": "https://chinese.alibaba.com/g/rtx-a4000-price.html",
        "Source_Type": "International",
        "Bulk_Notes": "$458-833 range, mixed A2000/A4000",
    },
    # EU Sources
    {
        "Model": "RTX A4000",
    ...
    # Router-Switch.com
    {
        ...
        "Source_Type": "Retail_Specialist",
        "Bulk_Notes": "Global warehouses, bulk savings available",
    },
]
...
print("\nPrice by condition:")
condition_stats = (
    df[df["Price_USD"] > 0].groupby("Condition")["Price_USD"].agg(["count", "mean", "min", "max"]).round(2)
)
