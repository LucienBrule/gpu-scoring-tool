...
def analyze_false_positives():
    ...
    intel_matches = df[df["title"].str.contains("Intel", case=False, na=False) & (df["canonical_model"] != "UNKNOWN")]
    amd_matches = df[
        df["title"].str.contains("AMD|Radeon", case=False, na=False) & (df["canonical_model"] != "UNKNOWN")
    ]
    ...
    for keyword in non_gpu_keywords:
        non_gpu_matches = df[df["title"].str.contains(keyword, case=False, na=False) & (df["is_valid_gpu"] == True)]
