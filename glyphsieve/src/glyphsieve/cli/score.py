...
@click.option(
    "--strategy", "-s", default="weighted", help="Scoring strategy to use (currently only 'weighted' is supported)"
)
def score(input, output, weights, strategy):
    ...
    try:
        ...
        if strategy != "weighted":
            console.print(
                f"[bold yellow]Warning:[/bold yellow] Strategy '{strategy}' not recognized. Using 'weighted' strategy."
            )
