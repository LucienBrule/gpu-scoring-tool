...
def test_get_top_cards_by_score():
    ...
    df = pd.DataFrame(
        [
            {"canonical_model": "H100_PCIE_80GB", "vram_gb": 80, "price": 10000.0, "score": 0.7},
            {"canonical_model": "A100_40GB_PCIE", "vram_gb": 40, "price": 8000.0, "score": 0.5},
            {"canonical_model": "RTX_4090", "vram_gb": 24, "price": 1500.0, "score": 0.3},
            {"canonical_model": "RTX_3090", "vram_gb": 24, "price": 1000.0, "score": 0.2},
        ]
    )
...
def test_find_price_anomalies():
    ...
    df = pd.DataFrame(
        [
            {"canonical_model": "RTX_4090", "price": 1500.0, "score": 0.3},
            {"canonical_model": "RTX_4090", "price": 2500.0, "score": 0.3},  # Significant price difference
            {"canonical_model": "RTX_3090", "price": 1000.0, "score": 0.2},
            {"canonical_model": "RTX_3090", "price": 1100.0, "score": 0.2},  # Small price difference, not an anomaly
        ]
    )
...
def test_find_duplicate_anomalies():
    ...
    df = pd.DataFrame(
        [
            {"id": 1, "canonical_model": "RTX_4090", "price": 1500.0, "score": 0.3, "duplicate_flag": "PRIMARY"},
            {
                "id": 2,
                "canonical_model": "RTX_4090",
                "price": 1600.0,
            ...
            {"id": 3, "canonical_model": "RTX_3090", "price": 1000.0, "score": 0.2, "duplicate_flag": "PRIMARY"},
            {
                "id": 4,
    ...
    df_no_dupes = pd.DataFrame([{"canonical_model": "RTX_4090", "price": 1500.0, "score": 0.3}])
