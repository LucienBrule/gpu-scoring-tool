...
class GPUScoringModelFixed:
    ...
    def normalize_metrics(self, df):
        ...
        df_norm["price_efficiency_score"] = (
            df_norm["price_efficiency_score"] / df_norm["price_efficiency_score"].max()
        ) * 100
        ...
        df_norm["power_efficiency_score"] = (
            df_norm["power_efficiency_score"] / df_norm["power_efficiency_score"].max()
        ) * 100
